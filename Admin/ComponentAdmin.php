...
class ComponentAdmin extends BaseResourceAdmin
{
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->addOrderBy($query->getRootAliases()[0] . '.templateContainer', 'ASC');
        $query->addOrderBy($query->getRootAliases()[0] . '.position', 'ASC');
        $query->addOrderBy($query->getRootAliases()[0] . '.title', 'ASC');
